//simulates the popular snakes and ladders game 
//from Akash Mahesh 
//RULES : 
//1. game starts with any dice value 
//2. a chance is awarded when 6 (six) appears 
//3. only current location of current player is hown on the board,
         // location is shown below the board 
...
void displaychart(int curp, char player[4]){
    int i, j, t, c, stf =0, diceres,pos1,pos2;
