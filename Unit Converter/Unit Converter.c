...
int main(){ 
    ...
    int currencyChoice; 
    int massChoice; 
    int userinputF; //input from user in Fahreinheit
    int userinputC; //input from user in Celsius 
    int userinputUSDtoEuro; //input from user from USD to EURO 
    int userinputUSDtoJPY; // input from user for USD to JPY;
    int userinputUSDtoRMB; //input from user for USD to RMB;
    int userinputOunce; // input from user for Ounce;
    int userinputGram; // input from user for Gram;
